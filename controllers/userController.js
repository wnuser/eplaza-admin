...
const createUser = async (req, res) => {
    ...
    const saveUser = await userModel.create(data).then(function(data){

        let successResponse = {data, message:"User registered successfully"}; 
    ...
    const result = await userModel.findAll({
        where: {
          ...
          if(Object.keys(data).length === 0) {
              response = { data, message:"Invalid otp or user_id" }
